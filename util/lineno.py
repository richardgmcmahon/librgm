...
def lineno(USEtraceback=False, functionName=True, fileName=True,
    ...
    Also inspect.stack and traceback.extract_stack return stack entries
    ...
    line number information for the calling fucntion i.e. [1] for the index;
    [0] is this function. [-1] would be the main.

    Traceback start at the other end so needs [-2] for the index to
    the calling function [-] refers to this function. [0] would be
    the main function.
